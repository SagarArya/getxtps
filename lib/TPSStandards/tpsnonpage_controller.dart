...
import '../app/data/model/model.dart';

class TPSNonPageController extends GetxController {
  //Initialised properties  --------------------------------------
  final Repository repository; //May remove repository
  TPSNonPageController({required this.repository})
  ...
  Future<void> dosomethings(Model word) async {
    return;
  }
